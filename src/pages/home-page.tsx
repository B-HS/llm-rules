...
const SUPPORT_LAYERS = [
    ...
    { label: '워크플로', codex: 'Skills', claude: 'Slash Commands' },
    { label: '전문 리뷰', codex: 'Custom Agents', claude: 'Subagents' },
...
export const HomePage: FC = () => (
    <div className='mx-auto w-full max-w-6xl px-5 py-12 sm:px-8 sm:py-16 lg:py-20'>
        <Head>
            ...
            <meta name='description' content='하나의 코딩 컨벤션을 Codex와 Claude Code에서 Hooks, Skills, Commands, Agents로 네이티브 실행합니다.' />
        </Head>
        ...
        <section className='max-w-4xl'>
            ...
            <p className='mt-6 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg'>
                공통 컨벤션은 하나로 유지하고 각 환경의 Hooks, Skills, Commands, Agents와 권한 체계로 반복 작업과 검증을 자동화합니다.
            </p>
            ...
            <div className='grid gap-4 lg:grid-cols-2'>
                <article className='flex min-w-0 flex-col rounded-2xl border border-border bg-card p-5 shadow-sm sm:p-6'>
                    ...
                    <p className='mt-4 text-sm leading-6 text-muted-foreground'>
                        Instructions부터 Hooks, Skills, Custom Agents, Rules까지 한 번에 설치합니다.
                    </p>
                ...
                <article className='flex min-w-0 flex-col rounded-2xl border border-border bg-card p-5 shadow-sm sm:p-6'>
                    ...
                    <p className='mt-4 text-sm leading-6 text-muted-foreground'>
                        공통 컨벤션을 먼저 설치한 뒤 기존 Claude Code 네이티브 레이어를 그대로 추가합니다.
                    </p>
                    <pre className='mt-5 overflow-x-auto rounded-xl border border-border bg-muted/50 p-4 text-xs leading-6'>
        ...
        <section className='mt-16 rounded-2xl border border-border bg-muted/30 p-5 sm:p-8' aria-labelledby='native-support'>
            <div className='max-w-2xl'>
                ...
                <p className='mt-3 text-sm leading-6 text-muted-foreground'>
                    Claude Code 자산은 기존 구조를 유지하고 Codex 자산은 별도 경로에서 병렬 관리합니다.
                </p>
            </div>
